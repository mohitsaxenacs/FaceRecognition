...
public class FaceUtils {
	...
	public static FaceModel getFaceModel(Mat origin) {
		...
		faceCascade
				.load("C:/FaceRecognition/opencv/sources/data/haarcascades/haarcascade_frontalface_alt.xml");
		eyesCascade
				.load("C:/FaceRecognition/opencv/sources/data/haarcascades/haarcascade_eye.xml");
		eyesGlassesCascade
				.load("C:/FaceRecognition/opencv/sources/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml");
